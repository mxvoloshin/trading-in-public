...
def _handle_backtest_run(args: argparse.Namespace) -> int:
    ...
    print(f"avg_mfe={summary.avg_mfe}")
    print(f"median_mfe={summary.median_mfe}")
    print(f"avg_mae={summary.avg_mae}")
    print(f"median_mae={summary.median_mae}")
    print(f"avg_final_r={summary.avg_final_r}")
    print(f"median_final_r={summary.median_final_r}")
    print(f"avg_max_favorable_r={summary.avg_max_favorable_r}")
    print(f"median_max_favorable_r={summary.median_max_favorable_r}")
    print(f"avg_max_adverse_r={summary.avg_max_adverse_r}")
    print(f"median_max_adverse_r={summary.median_max_adverse_r}")
    print(f"pct_reached_1r={summary.pct_reached_1r}")
    print(f"pct_reached_2r={summary.pct_reached_2r}")
    print(f"pct_reached_3r={summary.pct_reached_3r}")
    print(f"pct_reached_1r_then_negative={summary.pct_reached_1r_then_negative}")
